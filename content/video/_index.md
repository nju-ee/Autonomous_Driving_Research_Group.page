...
sections:
  ...
  - block: markdown
    content:
      ...
      subtitle: ''
      text: <br><p> <img  src="dataset.jpg" align="center" width="600" />We build the panoramic human activity dataset WristDaily360 from the perspective of wrist wearing. This dataset collects panoramic human behavior video data recorded from the wrist perspective. Its content mainly records people's daily activities, including sports, entertainment, household chores, learning, and other activities. </p> <br><br> <video src="dataset.mp4" autoplay="autoplay" loop="loop" controls="controls"></video>
